...
if [ -r "$DIR/config" ]; then
	...
	source "$HOME/scripts/rofi/wifi-menu.sh"
else
...
CHENTRY=$(echo -e "$TOGGLE\nmanual\n$LIST" | uniq -u | rofi -dmenu -p "Wi-Fi SSID" -lines "$LINENUM" -a "$HIGHLINE" -location "$POSITION" -yoffset "$YOFF" -xoffset "$XOFF" -config $HOME/.config/rofi/configs/wifimenu.rasi -width -"$RWIDTH")
#echo "$CHENTRY"
